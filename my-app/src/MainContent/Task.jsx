...
import { decreaseNumber } from "../store/slices/taskCountSlice";
    ...
    return (
        <div className="flex flex-col justify-between align-center group text-white bg-gradient-to-br from-purple4 to-purple3 p-6 rounded-lg shadow-md shadow-purple4">
            ...
            <div className="flex flex-row justify-between align-center">
                ...
                <div className="text-2xl text-center font-semibold"> {props.data.title}</div>
            ...
            <div className="flex flex-row justify-between align-center mt-10">
                ...
                <div className={`rounded-xl text-center text-black px-3 py-1 ${props.data.color}`}>
                    {props.data.tag}
                </div>
